...
struct AccountList: View {
    ...
    var body: some View {
        ...
        NavigationView {
            List {
                ForEach(userData.AccountsList) { accountt in
                    NavigationLink(destination: AccountDetails(account: accountt)) {
                        AccountItem(account: accountt)
    ...
    func delete(at offsets: IndexSet) {
        ...
        if let index = offsets.first {
            ...
            let nameOfFileToDelete = userData.AccountsList[index].category
            ...
            do {
                ...
                print("Unable to delete the account file from the document directory.")
            }
